...
from game_classes import Vector2, Game_Object, State_Machine, State, Entity, Rectangle
import sprites
import sounds
from etc import accelerate
import level
...
class Brick(Game_Object):
    ...
    def instantiate_fragments(self):
        ...
        level.brick_fragments.append(
            Brick_Fragment(Vector2(self.pos.x + 24, self.pos.y), Vector2(0.1, -0.5), Rectangle()))
        level.brick_fragments.append(
            Brick_Fragment(Vector2(self.pos.x + 24, self.pos.y + 24), Vector2(0.1, -0.4), Rectangle()))
        level.brick_fragments.append(
            Brick_Fragment(Vector2(self.pos.x, self.pos.y + 24), Vector2(-0.1, -0.4), Rectangle()))
