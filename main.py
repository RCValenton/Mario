...
import sprites
import sounds
from game_classes import Camera, Vector2, Rectangle, Digit_System
import pygame as pg
...
class Main:
    ...
    def draw_background(self):
        c.screen.blit(sprites.background, (0, 0), (c.camera.pos.x, c.camera.pos.y, c.SCREEN_SIZE.x, c.SCREEN_SIZE.y))
